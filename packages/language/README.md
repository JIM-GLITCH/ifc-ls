...
- [src/ifc.langium](src/ifc.langium) -  The grammar definition of your language
- [src/ifc-module.ts](src/ifc-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/ifc-validator.ts](src/ifc-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/ifc.monarch.ts](src/syntaxes/ifc.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/ifc.tmLanguage.json](syntaxes/ifc.tmLanguage.json) - Textmate based syntax highlighting instructions.
